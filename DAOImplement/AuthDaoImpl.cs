            ...
            try
            {
                using (HttpClient httpClient = new HttpClient())
                {
                    ...
                    if (httpResponse.IsSuccessStatusCode)
                    {
                        ...
                        CurrentUser.Instance.SetUser(dataUsuario.id_usuario,dataUsuario.apellido, dataUsuario.nombre, dataUsuario.organismo, dataUsuario.activo, dataUsuario.roles);
