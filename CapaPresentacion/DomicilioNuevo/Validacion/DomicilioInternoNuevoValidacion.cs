...
namespace CapaPresentacion.DomicilioNuevo.Validacion
{
    public class DomicilioInternoNuevoValidacion : AbstractValidator<DomicilioInternoNuevoDatos>
    {
        public DomicilioInternoNuevoValidacion()
        {
            RuleFor(x => x.cmbPais)
