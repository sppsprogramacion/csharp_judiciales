...
namespace CapaPresentacion.Validaciones.HistorialProcesalAdministrar.Validacion
{
    public class HistorialProcesalAdministrarValidation : AbstractValidator<HistorialProcesalAdministrarDatos>
    {
