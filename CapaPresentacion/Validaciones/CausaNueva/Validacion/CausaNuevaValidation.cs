...
namespace CapaPresentacion.Validaciones.CausaNueva.Validacion
{
    public class CausaNuevaValidation: AbstractValidator<CausaNuevaDatos>
    {
        public CausaNuevaValidation()
        {
